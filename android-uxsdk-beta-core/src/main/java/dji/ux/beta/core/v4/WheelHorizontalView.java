...
public class WheelHorizontalView extends AbstractWheelView {
    ...
    public WheelHorizontalView(Context context, AttributeSet attrs) {
        // Clean the reading warning on the empty style
    ...
    public void setSelectorPaintCoeff(float coeff) {
        ...
        if (mVisibleItems == 2) {
            ...
            int[] colors =      {0x07000000, c3, c2, c1, 0xff000000, 0xff000000, c1, c2, c3, 0x07000000};
    ...
    protected void createItemsLayout() {
        if (mItemsLayout == null) {
            ...
            mItemsLayout.setGravity(Gravity.CENTER_VERTICAL);
    ...
    protected void doItemsLayout() {
        mItemsLayout.layout(0, 0, getMeasuredWidth(), getMeasuredHeight());
    }
...
//
//        int height = heightSize; //calculateLayoutHeight(heightSize, heightMode);
//
//        int width;
